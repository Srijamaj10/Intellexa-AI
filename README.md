...
Automated PDF Parsing & Analysis: Extract and summarize content from research PDFs effortlessly.

AI‑Driven Paper Drafting: Generate structured research drafts on any topic using advanced reasoning.
...
✔ Analyzing and summarizing academic papers
✔ Extracting key insights automatically
✔ Brainstorming new research ideas using AI
✔ Drafting fully structured research documents
✔ Rendering professional PDFs with equations and formatting
...
Google Gemini AI – NLP and reasoning engine

PyPDF2 & Requests – PDF handling and data fetching
...
git clone https://github.com/yourusername/Intellexa.git
cd Intellexa
